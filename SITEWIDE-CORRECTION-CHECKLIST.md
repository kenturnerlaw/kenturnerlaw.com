...
## Shared menu
- [ ] Apply the canonical homepage hamburger to every public page.
- [ ] Remove every text button labeled `Menu`.
- [ ] Apply one identical AMP sidebar menu to every public page.
- [ ] Confirm menu order, labels, links, indentation, typography, colors, spacing, close control, and call action match.
- [ ] Remove duplicate menus, inline navigation rows, and page-specific menu variants.
...
- [ ] Compare gold page headings against the existing homepage design.
- [ ] Compare gold section headings against the existing homepage design.
- [ ] Confirm body copy remains white or near-white.
- [ ] Confirm supporting text remains smaller and white or near-white.
- [ ] Present the gold-heading comparison for approval before broad application.
- [ ] Apply an approved heading treatment consistently without redesigning layouts.
