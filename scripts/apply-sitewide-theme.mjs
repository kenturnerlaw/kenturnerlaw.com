...
const theme = `${START}
:root{--kt-v2-leather:url('/img/dark-automotive-leather-v3.webp');--kt-v2-leather-size:420px 420px;--kt-v2-gold:#c99537;--kt-v2-gold-light:#f7dea0;--kt-v2-gold-edge:#65400e;--kt-v2-shadow:#2a1603}
html{background:#020202}
body{color:#f7f1e4;background-color:#030303;background-image:linear-gradient(rgba(0,0,0,.08),rgba(0,0,0,.14)),var(--kt-v2-leather);background-size:100% 100%,var(--kt-v2-leather-size);background-repeat:repeat;background-attachment:fixed}
p,li,dd,blockquote,main article{color:#f7f1e4}
.ampstart-headerbar{background-color:#030303;background-image:linear-gradient(rgba(0,0,0,.22),rgba(0,0,0,.34)),var(--kt-v2-leather);background-size:100% 100%,var(--kt-v2-leather-size);border-bottom:1px solid #9b7326;box-shadow:0 2px 12px rgba(0,0,0,.72),inset 0 1px 0 rgba(255,255,255,.045)}
.ampstart-sidebar{background-color:#030303;background-image:linear-gradient(rgba(0,0,0,.2),rgba(0,0,0,.3)),var(--kt-v2-leather);background-size:100% 100%,var(--kt-v2-leather-size);border-right:1px solid #8f6b1f;box-shadow:10px 0 30px rgba(0,0,0,.7)}
...
.ampstart-btn,.button,.btn,input[type='submit']{border:1px solid #9b7326;background-color:#050505;background-image:linear-gradient(rgba(0,0,0,.14),rgba(0,0,0,.28)),var(--kt-v2-leather);background-size:100% 100%,var(--kt-v2-leather-size);box-shadow:inset 0 0 0 1px rgba(255,224,125,.12),0 5px 14px rgba(0,0,0,.58)}
details.kt-acc,details[class*='acc'],.panel,.card,.box,.ampstart-card,amp-accordion>section{background-color:#040404;background-image:linear-gradient(rgba(0,0,0,.18),rgba(0,0,0,.26)),var(--kt-v2-leather);background-size:100% 100%,var(--kt-v2-leather-size);border-color:#8e651e;box-shadow:0 6px 18px rgba(0,0,0,.58),inset 0 0 0 1px rgba(255,222,118,.08)}
