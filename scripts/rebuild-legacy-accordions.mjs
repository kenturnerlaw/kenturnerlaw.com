...
body:not(.kt-home-rebuild) details.kt-acc>div{padding:22px 26px;background-color:#040404;background-image:linear-gradient(rgba(1,1,1,.48),rgba(1,1,1,.58)),var(--kt-v2-leather);background-size:auto,460px 460px;border-top:1px solid rgba(201,149,55,.42)}
...
.kt-home-rebuild details.kt-acc>summary{display:flex;align-items:center;min-height:112px;padding:20px 62px 20px 26px;text-align:left;background-color:#050505;background-image:linear-gradient(90deg,rgba(0,0,0,.18),rgba(0,0,0,.42)),var(--kt-v2-leather);background-repeat:no-repeat,repeat;background-position:center,center;background-size:100% 100%,460px 460px}
...
.kt-home-rebuild details.kt-acc>article,.kt-home-rebuild details.kt-acc>div{background-color:#040404;background-image:linear-gradient(rgba(1,1,1,.48),rgba(1,1,1,.58)),var(--kt-v2-leather);background-size:auto,460px 460px;border-top:1px solid rgba(201,149,55,.42)}
@media(max-width:600px){
  ...
  body:not(.kt-home-rebuild) details.kt-acc>summary{min-height:104px;padding:17px 48px 17px 20px;font-size:.98rem;background-position:center,center;background-size:100% 100%,420px 420px}
  body:not(.kt-home-rebuild) details.kt-acc>summary:after{right:15px}
  body:not(.kt-home-rebuild) details.kt-acc>article,
  body:not(.kt-home-rebuild) details.kt-acc>div{padding:18px}
  .kt-home-rebuild details.kt-acc>summary{min-height:104px;padding:17px 48px 17px 20px;background-position:center,center;background-size:100% 100%,420px 420px}
